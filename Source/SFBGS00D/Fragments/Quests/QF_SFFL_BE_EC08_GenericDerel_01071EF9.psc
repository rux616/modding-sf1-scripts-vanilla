...
Scriptname SFBGS00D:Fragments:Quests:QF_SFFL_BE_EC08_GenericDerel_01071EF9 Extends Quest Hidden Const
...
;END AUTOCAST
;BEGIN CODE
;Chance to spawn from 1 to 4 pirates inside the ship, with the possibility of a boss
int pirateQuantity = Math.Max(Utility.RandomInt(1,6) + Utility.RandomInt(1,6) - 8,0) as int
if (pirateQuantity > 0)
...
;END AUTOCAST
;BEGIN CODE
;Turn off some lights inside derelict
kmyQuest.TurnOffLights()

;Refill Doors Alias for opening them with Terminals
...
;Scene Property SFFL_BE_EC08_Derelict_200_Alarm Auto Const Mandatory
