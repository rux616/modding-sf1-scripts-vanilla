...
Scriptname SFBGS00D:Fragments:Quests:QF_SFFL_SE_JG04_B_Starborn_0108F502 Extends Quest Hidden Const
...
int RandomShipPicker = Utility.RandomInt(1,10)

if RandomShipPicker <= 3
   ;Spawn 2 ships
...
ElseIf RandomShipPicker > 3 && RandomShipPicker <= 5
   ;EDIT: Spawn 1 ship
   kmyquest.ActivateAttackingShip(1.5,Alias_Enemy01,Alias_PlayerShip)
   ;kmyquest.ActivateAttackingShip(0.5,Alias_Enemy02,Alias_PlayerShip)
